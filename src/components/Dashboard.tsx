...
const quickActions = [
  { id: 'ai-generator' as Screen, icon: Image, label: 'Generate AI Image', description: 'Create unique images from prompts', gradient: 'from-violet-500 to-purple-500' },
...
export function Dashboard({ onNavigate }: DashboardProps) {
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-12 bg-gradient-to-br from-violet-500 via-purple-500 to-fuchsia-500 rounded-3xl p-8 text-white shadow-2xl shadow-purple-500/30 relative overflow-hidden">
